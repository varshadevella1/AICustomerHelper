...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://sample_user:sample_password@cluster0.example.mongodb.net/chatbot';
...
export async function connectToDatabase() {
  try {
    ...
    if (!MONGODB_URI || 
      ...
      console.error('Using in-memory storage instead. Data will be lost when the server restarts.');
    ...
    console.log('Using in-memory storage instead. Data will be lost when the server restarts.');
